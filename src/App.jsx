                ...
                <div className="max-w-[1600px] mx-auto px-6 py-4">
                    <div className="flex items-center justify-between gap-4">
                        <div className="flex items-center gap-2 shrink-0 cursor-pointer" onClick={() => navigate('/')}>
                            ...
                            <h1 className="text-xl font-black text-slate-900 tracking-tight hidden md:block">ODS <span className="text-blue-600">PILOT</span> <span className="text-[10px] font-bold text-slate-400 align-top">v4.1</span></h1>
                        </div>
                        ...
                        <div className="flex items-center gap-2 bg-slate-50 p-1.5 rounded-2xl border border-slate-100 shrink-0">
                            <div className="hidden lg:flex flex-col items-end px-3">
                                ...
                                <span className="text-[10px] opacity-30 font-black ml-2">V4.1-DEPLOY</span>
                            </div>
