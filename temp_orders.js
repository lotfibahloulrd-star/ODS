...
const INITIAL_ORDERS = [
    ...
    },
    {
        ...
        refOds: 'L05/25/INV',
        object: '2 Spectrophotom├¿tres de terrain',
        dateOds: '2025-05-15',
        delay: '90',
        amount: '0',
    ...
    },
    {
        ...
        object: 'SAA Flamme & Four / COT-m├¿tre',
        dateOds: '2025-11-02',
        delay: '120',
        amount: '21340070.00',
        division: 'Division Analytique',
    ...
    },
    {
        ...
        object: '├ëquipements G├®nie M├®canique',
        dateOds: '2025-11-27',
        delay: '120',
        amount: '0',
        division: 'Division Laboratoire',
    ...
    },
    {
        ...
        client: 'Gendarmerie (INCC)',
        refOds: '077/393',
        object: 'Maintenance Pr├®v. & Corrective',
        dateOds: '2025-12-03',
        delay: '365',
        amount: '71400000',
        division: 'Division Analytique',
    ...
    },
    {
        ...
        object: 'Mat├®riels thermiques de labo',
        dateOds: '2025-12-11',
        delay: '90',
        amount: '0',
        division: 'Division Laboratoire',
    ...
    },
    {
        ...
        object: '├ëquipements Scientifiques',
        dateOds: '2025-12-15',
        delay: '90',
        amount: '9424800.00',
        division: 'Division Analytique',
    ...
    },
    {
        ...
        refOds: 'Contrat 82',
        object: 'R├®paration ├®quipements m├®dico',
        dateOds: '2025-12-24',
        delay: '30',
        amount: '386750.00',
        division: 'Division Analytique',
    ...
    },
    {
        id: 'init-13',
        client: 'Univ. B├®ja├»a',
        refOds: 'March├® 17/2025 (Lot 02)',
        object: '├ëquipements ├ëlectrochimie',
        dateOds: '2025-12-30',
        delay: '120',
        amount: '0',
        division: 'Division Analytique',
    ...
    },
    {
        ...
        object: '├ëquipements Labo Pharmacie',
        dateOds: '2026-01-08',
        delay: '120',
        amount: '0',
        division: 'Division Analytique',
...
export const orderService = {
    ...
    createOrder: async (orderData) => {
        ...
        notificationService.addNotification(
            `Nouveau document ins├®r├® : ODS ${newOrder.refOds} (${newOrder.client}) - Division: ${newOrder.division}`,
            'info',
            ['all'],
            newOrder.id
        );
    ...
    updateOrder: async (id, updates, userName) => {
        ...
        // 1. Authorization Confirm├®e
        if (oldOrder.importStatus?.authImport !== 'Confirm├®e' && newOrder.importStatus?.authImport === 'Confirm├®e') {
            notificationService.addNotification(
                `Autorisation confirm├®e pour l'ODS ${newOrder.refOds} (${newOrder.client}).`,
                'success',
                ['all'],
                newOrder.id
            );
        ...
        if (!oldOrder.importStatus?.importLaunched && newOrder.importStatus?.importLaunched) {
            notificationService.addNotification(
                `Importation lanc├®e pour l'ODS ${newOrder.refOds} (${newOrder.client}). D├®lai de d├®douanement estim├® : ${newOrder.importStatus?.estCustomsDate ? new Intl.DateTimeFormat('fr-FR').format(new Date(newOrder.importStatus.estCustomsDate)) : 'Non d├®fini'}.`,
                'info',
                ['all'],
                newOrder.id
            );
        ...
        if (!oldOrder.importStatus?.clearedAt && newOrder.importStatus?.clearedAt) {
            notificationService.addNotification(
                `D├®douanement termin├® pour l'ODS ${newOrder.refOds} (${newOrder.client}).`,
                'success',
                ['all'],
                newOrder.id
            );
        ...
        if (oldOrder.stockStatus?.reception !== 'Totale' && newOrder.stockStatus?.reception === 'Totale') {
            ...
            notificationService.addNotification(
                `Notification : ODS ${newOrder.refOds} (${newOrder.client}) est PR├èT ├Ç ├èTRE LIVR├ë !`,
                'success',
                ['all'],
                newOrder.id
            );
